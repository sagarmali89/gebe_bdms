...
define('EMAIL_FROM',                            'gebedispatch@gmail.com');		// e.g. email@example.com
define('EMAIL_BCC',                            	'gebedispatch@gmail.com');		// e.g. email@example.com
define('FROM_NAME',                             'BDMS - GEBE');	// Your system name
define('EMAIL_PASS',                            'OM64XLSOM64XLS');	// Your email password
define('PROTOCOL',                             	'smtp');				// mail, sendmail, smtp
define('SMTP_HOST',                             'ssl://smtp.googlemail.com');		// your smtp host e.g. smtp.gmail.com
define('SMTP_PORT',                             '465');					// your smtp port e.g. 25, 587
define('SMTP_USER',                             'gebedispatch@gmail.com');		// your smtp user
define('SMTP_PASS',                             'OM64XLSOM64XLS');	// your smtp password
define('MAIL_PATH',                             '/usr/sbin/sendmail');