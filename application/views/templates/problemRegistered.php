...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Break Down Registered Confirmation</title>
    </head>
    <body>
        <div>
                                                            ...
                                                            <cite style="text-align:center;display:block;font-style:normal">
                                                                ...
                                                                <dl style="list-style-type:none;padding:0;overflow:hidden;margin:0">
                                                                    <dt style="font-size:15px;display:inline-block;width:100%;margin:0;padding:0 0 12px 0;vertical-align:top;padding-bottom:0!important">
                                                                        <a href="<?php echo base_url(); ?>" title="GEBE" style="display:inline-block" target="_blank">GEBE</a>
                                                                    </dt>
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" style="width:100%;margin:0;padding:0">
                                                                    <tbody>
                                                                        <tr>
                                                                            <td align="center">
                                                                                <div style="width:100%">
                                                                                    <b>Hi, <?php echo $data["name"]; ?></b>! <span class="il">
                                                                                        <?php //echo $data["message"]; ?>
                                                                                        <p>This is confirmation email to kindly inform you, that your compalin has been <b>registered</b> with us.
                                                                                            Our expert technician will get back to you and solve the issue asap.</p>
                                                                                        <br/>
                                                                                        Thanks
