        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="box box-primary">
                    ...
                    <form role="form" id="addUser" action="<?php echo base_url() . $redirect_key; ?>addNewEmployee" method="post" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control required" id="emp_id" value="<?php echo set_value('emp_id'); ?>" name="emp_id">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
