            ...
            <div class="col-md-8">
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Enter Vacation Details</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->

                    <form role="form" action="<?php echo base_url().$redirect_key; ?>editEmployee" method="post" id="editUser" role="form">
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6">                                
                                ...
                                <div class="col-md-6">                                
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="emp_id" placeholder="Emp ID" name="emp_id" value="<?php echo $emp_id; ?>" >                                        
                                    </div>                                    
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
